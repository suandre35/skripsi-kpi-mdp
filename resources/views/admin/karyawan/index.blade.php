                ...
                <div class="p-6 border-b border-gray-100 dark:border-gray-700">
                    <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                        ...
                        <form method="GET" action="{{ route('karyawan.index') }}" class="flex flex-col md:flex-row gap-3 w-full lg:w-auto">
                            ...
                            {{-- Filter Divisi --}}
                            <select name="divisi" onchange="this.form.submit()" class="block w-full md:w-48 p-2.5 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                            ...
                            {{-- Filter Status --}}
                            <select name="status" onchange="this.form.submit()" class="block w-full md:w-40 p-2.5 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                            ...
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition duration-150">
                                ...
                                {{-- KOLOM 1: PROFIL (FOTO & NAMA) --}}
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center gap-3">
                                        {{-- Logic Tampilkan Foto --}}
                                ...
                                {{-- KOLOM 4: STATUS --}}
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ $karyawan->status_karyawan == 'Aktif' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800' }}">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-center">
                                    <a href="{{ route('karyawan.edit', $karyawan->id_karyawan) }}" class="text-indigo-600 hover:text-indigo-900 p-2 hover:bg-indigo-50 rounded-lg transition" title="Edit">
