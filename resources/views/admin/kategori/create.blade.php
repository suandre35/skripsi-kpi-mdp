        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-2xl border border-gray-100 dark:border-gray-700">
                ...
                <div class="px-6 py-4 border-b border-gray-100 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-700/50">
                    <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100">Formulir Kategori</h3>
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Buat kategori baru untuk mengelompokkan indikator kinerja.</p>
                </div>
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" name="nama_kategori" id="nama_kategori" value="{{ old('nama_kategori') }}" required placeholder="Contoh: Kinerja Individu, Disiplin, Target Omset"
                                ...
                                <p class="mt-1 text-xs text-gray-500">Nama kategori akan muncul di rapor penilaian.</p>
                            </div>
