                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" name="nama_periode" value="{{ old('nama_periode') }}" required placeholder="Contoh: Q1 2025 (Januari - Maret)"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="datetime-local" name="tanggal_pengumuman" value="{{ old('tanggal_pengumuman') }}" required
                                            class="pl-10 block w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:ring-blue-500 focus:border-blue-500 shadow-sm sm:text-sm transition duration-150">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <p class="mt-2 text-xs text-blue-500 flex items-center gap-1">
                                    ...
                                    Jika Anda memilih <strong>Aktif</strong>, periode aktif yang lain akan otomatis dinonaktifkan.
                                </p>
                            </div>
