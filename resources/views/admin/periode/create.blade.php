        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-2xl border border-gray-100 dark:border-gray-700">
                ...
                <div class="px-6 py-4 border-b border-gray-100 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-700/50">
                    <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100">Jadwal Evaluasi</h3>
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Tentukan rentang waktu penilaian kinerja.</p>
                </div>

                <div class="p-6 md:p-8">
                    
                    {{-- Validasi Error Global (Summary) --}}
                    @if ($errors->any())
                        <div class="mb-6 p-4 rounded-lg bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 text-red-700 dark:text-red-400">
                            <div class="flex items-center gap-2 mb-2">
                                ...
                                <strong class="font-bold text-sm">Periksa input Anda!</strong>
                            </div>
                    ...
                    {{-- FORM START: Novalidate ditambahkan agar validasi HTML browser mati --}}
                    <form action="{{ route('periode.store') }}" method="POST" novalidate>
                        @csrf
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" name="nama_periode" value="{{ old('nama_periode') }}" placeholder="Contoh: Q1 2025 (Januari - Maret)"
                                        class="pl-10 block w-full rounded-lg shadow-sm sm:text-sm transition duration-150 dark:bg-gray-700 dark:text-white
                                        {{ $errors->has('nama_periode') 
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                {{-- Mulai --}}
                                <div>
                                    <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Waktu Mulai <span class="text-red-500">*</span></label>
                                    <div class="relative">
                                        <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                ...
                                {{-- Selesai --}}
                                <div>
                                    <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Waktu Selesai <span class="text-red-500">*</span></label>
                                    <div class="relative">
                                        <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <select name="pengumuman" 
                                            ...
                                            {{ $errors->has('pengumuman') 
                                                ? 'border-red-500 text-red-900 focus:ring-red-500 focus:border-red-500 dark:border-red-500 dark:text-red-400' 
                                                : 'border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:border-gray-600' }}">
                                            <option value="0" {{ old('pengumuman') == '0' ? 'selected' : '' }}>Tertutup (Disembunyikan)</option>
                                            <option value="1" {{ old('pengumuman') == '1' ? 'selected' : '' }}>Terbuka (Dapat Dilihat)</option>
                                        </select>
                                    </div>
                                    @error('pengumuman')
                                        <p class="mt-1 text-xs text-red-600 dark:text-red-400">{{ $message }}</p>
                                    @enderror
                                    <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Jika "Terbuka", karyawan bisa melihat hasil rapor mereka.</p>
                                </div>
