<x-app-layout>
    {{-- PENTING: x-data harus membungkus seluruh konten agar modal bisa diakses --}}
    <div x-data="{ showDeleteModal: false, deleteUrl: '' }">
                                ...
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition duration-150 {{ $periode->status == 'Aktif' ? 'bg-blue-50/30 dark:bg-blue-900/10' : '' }}">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-center">
                                        <div class="flex items-center justify-center gap-2">
                                            ...
                                            <button @click="showDeleteModal = true; deleteUrl = '{{ route('periode.destroy', $periode->id_periode) }}'"
        ...
        {{-- 3. PANGGIL COMPONENT MODAL DELETE DI SINI --}}
        <x-modal-delete />
