            ...
            <div class="relative" x-data="{ dropdownOpen: false }" @click.outside="dropdownOpen = false">
                <a class="flex items-center gap-4 cursor-pointer" href="#" @click.prevent="dropdownOpen = !dropdownOpen">
                    <span class="hidden text-right lg:block">
                        ...
                        <span class="block text-xs text-gray-500 font-medium">{{ Auth::user()->email }}</span>
                    </span>

                    <span class="h-10 w-10 rounded-full bg-gray-300 flex items-center justify-center overflow-hidden border border-gray-200 dark:border-gray-600">
