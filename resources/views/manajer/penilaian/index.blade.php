                    ...
                    <ol class="inline-flex items-center space-x-1 md:space-x-3">
                        ...
                        <li aria-current="page">
                            <div class="flex items-center">
                                ...
                                <span class="ml-1 text-sm font-medium text-gray-800 dark:text-gray-100">Penilaian</span>
                            </div>
                        </li>
                    </ol>
                </nav>
                                ...
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition duration-150">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center gap-3">
                                            {{-- FOTO PROFIL --}}
                                            <div class="flex-shrink-0 w-10 h-10 rounded-full bg-gray-200 dark:bg-gray-700 flex items-center justify-center overflow-hidden border border-gray-300 dark:border-gray-600">
                                                @if($log->header->karyawan && $log->header->karyawan->foto)
                                                    <img src="{{ asset('storage/' . $log->header->karyawan->foto) }}" 
                                                         alt="Foto {{ $log->header->karyawan->nama_lengkap }}" 
                                    ...
                                    {{-- KOLOM 6: AKSI (MODAL DELETE IMPLEMENTED) --}}
                                    <td class="px-6 py-4 whitespace-nowrap text-center">
                                        <div class="flex items-center justify-center gap-2">
                                            @if($isInputOpen)
                                                ...
                                                {{-- 2. TOMBOL DELETE (Pemicu Modal) --}}
                                                <button 
                                                    @click="showDeleteModal = true; deleteUrl = '{{ route('penilaian.destroy', $log->id_penilaianDetail) }}'"
                                                    class="p-2 text-red-600 hover:bg-red-50 rounded-lg dark:text-red-400 dark:hover:bg-gray-700 transition" 
                                                    title="Hapus Log">
